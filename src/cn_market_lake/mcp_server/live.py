...
WHAT THIS IS FOR. `cml mcp --live` lets someone try the agent surface without
first spending hours on `cml init`. It is the on-ramp, not the destination.
...
LIVE_WARNING = (
    ...
    "screen, not as research data. Build a lake (`cml init`) for anything that "
