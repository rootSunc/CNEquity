...
httpx this project already pins. `pip install cn-market-lake` currently brings
...
from cn_market_lake.mcp_server.tools import ToolError

logger = logging.getLogger(__name__)

SERVER_NAME = "cn-market-lake"
